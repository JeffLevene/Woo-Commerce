							...
							<p class="form-field">
								...
								<div class="input">									
									<div class="main_choise">
										...
										<label for="multiple_grouping_product_no"><?php _e('Set grouping product with XPath', 'pmxi_plugin' )?></label>
									</div>
									<div class="switcher-target-multiple_grouping_product_no"  style="padding-left:17px;">
										<div class="input">
