...
if ( ! class_exists( 'WooCommerce_Certus_Connector' ) ) {
    
    class WooCommerce_Certus_Connector {
        
        private $name = 'woocommerce';

        public function __construct() {
            add_filter('certus_connector_get_order_count', array( &$this, 'get_order_count') );
            add_filter('certus_connector_get_orders', array( &$this, 'get_orders') );
        }
