...
function setup_framework_options(){
    ...
    $sections[] = array(
        ...
        'fields' => array(
			...
			array(
                ...
                'sub_desc' => __('Please enter in your google analytics tracking code here. <br/> Remember to include the <strong>entire script from google</strong>, if you just enter your tracking ID it wo\'nt work.', NECTAR_THEME_NAME),
	...
	$sections[] = array(
		'icon' => 'tint',
		'icon_class' => 'icon-large',
        'title' => __('Accent Color Options', NECTAR_THEME_NAME),
	...
	$sections[] = array(
	 ...
	 $sections[] = array(
		'icon' => 'bell-alt',
		'icon_class' => 'icon-large',
        'title' => __('Call To Action Options', NECTAR_THEME_NAME),
	...
	$sections[] = array(
		'icon' => 'home',
		'icon_class' => 'icon-large',
        'title' => __('Home Slider Options', NECTAR_THEME_NAME),
