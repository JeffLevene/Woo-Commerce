...
function nectar_register_js() {	
	...
	if (!is_admin()) { 
		...
		wp_register_script('blogmasonry', get_template_directory_uri() . '/js/blog-masonry.js', 'jquery', '3.1', TRUE);
		...
		wp_register_script('nectarFrontend', get_template_directory_uri() . '/js/init.js', array('jquery', 'superfish', 'carouFredSel', 'easing', 'flexslider', 'nicescroll'), '3.1', TRUE);
